package com.shopping.hanxiao.shopping.rxretrofit.http;
...
import com.shopping.hanxiao.shopping.rxretrofit.exception.RetryWhenNetworkException;
import com.shopping.hanxiao.shopping.rxretrofit.http.func.ExceptionFunc;
import com.shopping.hanxiao.shopping.rxretrofit.http.func.ResulteFunc;
...
import com.shopping.hanxiao.shopping.rxretrofit.subscribers.ProgressSubscriber;
...
//        this.appCompatActivity = new SoftReference(appCompatActivity);
        this.onNextSubListener = onNextSubListener;
        this.appCompatActivity = appCompatActivity;
    }
    ...
    public void httpDeal(Observable observable, BaseApi basePar) {
        ...
        /*ober回调，链接式返回*/
        if (onNextSubListener != null) {
            onNextSubListener.onNext(observable, basePar.getMethod());
        }
